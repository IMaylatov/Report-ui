  ...
  return (
    <AuthConsumer>
      {({ isAuthenticatedIdentityUser }) => {
        const isIdentityUser = isAuthenticatedIdentityUser();
        return (
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  {isIdentityUser && <TableCell>Тип</TableCell>}
                  <TableCell align="right" padding='none' width='35px'></TableCell>
                  {isIdentityUser && <TableCell align="right" padding='none' width='35px'></TableCell>}
                </TableRow>
              </TableHead>
              <TableBody>
